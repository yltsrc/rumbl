defmodule Rumbl.VideoControllerTest do
  ...
  @tag login_as: "alex"
  test "lists all user's videos on index page", %{conn: conn, user: user} do
    user_video = insert_video(user, title: "funny cats", url: "http://funnycats.com")
    other_video = insert_video(insert_user(username: "other"), title: "another video", url: "http://example.com")
  ...
  test "authorizes actions against access by other users", %{conn: conn, user: owner} do
    ...
    hacker = insert_user(username: "sneaky")
    conn = assign(conn, :current_user, hacker)
